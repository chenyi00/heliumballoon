...
// - Home:       0
// - IGate:      5
// Note to self: Lisa: KC3NRU, Anant: KC3NEE; Dr. Ménard: KC3NEF
#define S_CALLSIGN      "KC3NEF"
...
#define DISABLE_PATH_ABOVE_ALT_METRES 100000

// APRS comment: this goes in the comment portion of the APRS message. You
// might want to keep this short. The longer the packet, the more vulnerable
// it is to noise.
#if defined(TRACKSOAR_20)
	#define APRS_COMMENT    "JHU_BOX_2020"
#else
